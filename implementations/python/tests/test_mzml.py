...
from mzprov.canonicalize_mzml import compose_mzml_content_hash
...
def test_dot_d_sidecar_parser_rejects_mzml_type(tmp_path):
    ...
    from mzprov.errors import UnknownVersion
...
def test_verify_cli_finds_sidecar_via_mzml_path(tmp_path):
    ...
    from mzprov.cli import main as cli_main, EXIT_OK
...
def test_verify_cli_mzml_tamper_returns_5(tmp_path):
    from mzprov.cli import main as cli_main, EXIT_HASH_MISMATCH
